...
# This harness lives in the standards repo (evals/), co-located with the policy it
# tests. The prompt and standards it evaluates against are in the SAME repo.
SCRIPT_DIR = pathlib.Path(__file__).resolve().parent      # .../evals
STANDARDS_REPO_ROOT = SCRIPT_DIR.parent                   # repo root (has evaluator/, standards/)
...
def default_standards_dir():
    # The prompt and standards live in this same repo now (one level up from evals/).
    return STANDARDS_REPO_ROOT
